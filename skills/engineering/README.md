...
- **[write-a-tech-spec](./write-a-tech-spec/SKILL.md)** — Create a staff-engineer-quality tech spec through user interview and codebase exploration, with explicit tradeoffs, alternatives, and risks.
